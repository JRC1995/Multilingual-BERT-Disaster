...
test_tweet_ids['Spanish'] = spanish_tweet_ids[0:len_spanish//2]
test_tweets['Spanish'] = spanish_tweets[0:len_spanish//2]
test_labels['Spanish'] = spanish_labels[0:len_spanish//2]

rest_tweet_ids += spanish_tweet_ids[len_spanish//2:]
rest_tweets += spanish_tweets[len_spanish//2:]
rest_labels += spanish_labels[len_spanish//2:]
